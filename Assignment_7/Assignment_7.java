...
Name: Aniket Singh
Prn: 21070126013
Problem Statetment:Write a Java application that will be able to add, subtract, multiply, divide,
...
class RationalNumber {
    ...
    // Constructor for creating a Rational Number object
    public RationalNumber(int numerator, int denominator) {
        if (denominator == 0) {
            throw new IllegalArgumentException("Denominator cannot be zero.");
        }
// Set the numerator and denominator of the object
...
// Simplify the rational number
    ...
    // Method to convert a Rational Number to a double value
    ...
    // Method to simplify a Rational Number
    ...
    // Override the toString() method to display a Rational Number as a String
    @Override
