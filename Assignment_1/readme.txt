...
The Main class takes console inputs and the input option class takes all input types such as scanner, bufferedreader, datainputstream.

Calculator does the following funtions:-
1. Addition        
2. Subtraction     
3. Multiplication  
4. Division        
